Excellent. Below is your **final, GitHub-ready `README.md`** — fully formatted, with all requested custom badges, professional tone, PicoCalc focus, and quick start/developer sections.
